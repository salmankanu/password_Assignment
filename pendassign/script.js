...
function getpasswordLength() {
  let passwordLength = parseInt(prompt("please enter the number of characters that you want for your password. It must be more than 12 characters but less than 128."))
